      ...
      <div className="absolute top-60">
        {storedCart().map((itemObject) => (
          <>
            ...
            {/* <span>{itemObject.id.price}</span>
            <span>{itemObject.id.title}</span>
            <img src={itemObject.id.imageUrl} alt="productimage" /> */}
          </>
        ))}
